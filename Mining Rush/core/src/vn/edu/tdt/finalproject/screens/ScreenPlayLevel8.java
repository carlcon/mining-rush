...
public class ScreenPlayLevel8 extends AbstractScreen {
    ...
    public void show() {
        this.createCamera();
        createStageGame();
        PlayerInfo.setCurrentTarget(5800);
        ...
        lstAcRod.add(new ActorRod(279f, 178f, 60f, 50f, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(582f, 268f, 60f, 50f, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(25f, 383f, 60f, 50f, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(764f, 296f, 60f, 50f, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(111f, 119f, 60f, 50f, ActorRod.RodTag.ROCK_10));

        lstAcRod.add(new ActorRod(907f, 310f, 60f, 50f, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(148f, 310f, 60f, 50f, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(417f, 201f, 60f, 50f, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(393f, 353f, 60f, 50f, ActorRod.RodTag.ROCK_20));

        lstAcRod.add(new ActorRod(288f, 330f, 60f, 50f, ActorRod.RodTag.GOLD_50));

        lstAcRod.add(new ActorRod(578f, 50f, 60f, 50f, ActorRod.RodTag.GOLD_250));
        lstAcRod.add(new ActorRod(54f, 247f, 60f, 50f, ActorRod.RodTag.GOLD_250));
        lstAcRod.add(new ActorRod(851f, 164f, 60f, 50f, ActorRod.RodTag.GOLD_250));

        lstAcRod.add(new ActorRod(728f, 201f, 80f, 80f, ActorRod.RodTag.GOLD_500));
        lstAcRod.add(new ActorRod(324f, 80f, 80f, 80f, ActorRod.RodTag.GOLD_500));

        lstAcRod.add(new ActorRod(578f, 221f, 25f, 25f, ActorRod.RodTag.EMERALD_100));
        lstAcRod.add(new ActorRod(170f, 221f, 25f, 25f, ActorRod.RodTag.EMERALD_100));

        lstAcRod.add(new ActorRod(245f, 133f, 25f, 25f, ActorRod.RodTag.RUBY_150));
        lstAcRod.add(new ActorRod(724f, 108f, 25f, 25f, ActorRod.RodTag.RUBY_150));
        lstAcRod.add(new ActorRod(829f, 246f, 25f, 25f, ActorRod.RodTag.RUBY_150));
