...
public class ScreenPlayLevel14 extends AbstractScreen {
    ...
    public ScreenPlayLevel14(Application app) {
        super(app);
    }
    ...
    public void show() {
        this.createCamera();
        createStageGame();
        PlayerInfo.setCurrentTarget(10500);
        ...
        lstAcRod.add(new ActorRod(109f, 299f, 60f, 50f, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(740f, 311f, 60f, 50f, ActorRod.RodTag.ROCK_10));
        ...
        lstAcRod.add(new ActorRod(490f, 311f, 60f, 50f, ActorRod.RodTag.ROCK_10));

        lstAcRod.add(new ActorRod(308f, 384f, 60f, 50f, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(598f, 232f, 60f, 50f, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(848f, 365f, 60f, 50f, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(221f, 271f, 60f, 50f, ActorRod.RodTag.ROCK_20));

        lstAcRod.add(new ActorRod(308f, 105f, 60f, 50f, ActorRod.RodTag.GOLD_100));
        lstAcRod.add(new ActorRod(196f, 188f, 60f, 50f, ActorRod.RodTag.GOLD_100));

        lstAcRod.add(new ActorRod(366f, 267f, 60f, 50f, ActorRod.RodTag.GOLD_250));
        lstAcRod.add(new ActorRod(566f, 164f, 60f, 50f, ActorRod.RodTag.GOLD_250));

        lstAcRod.add(new ActorRod(726f, 136f, 80f, 80f, ActorRod.RodTag.GOLD_500));

        lstAcRod.add(new ActorRod(407f, 54f, 25f, 25f, ActorRod.RodTag.EMERALD_100));
        lstAcRod.add(new ActorRod(44f, 118f, 25f, 25f, ActorRod.RodTag.EMERALD_100));

        lstAcRod.add(new ActorRod(220f, 67f, 25f, 25f, ActorRod.RodTag.RUBY_150));

        lstAcRod.add(new ActorRod(883f, 284f, 25f, 25f, ActorRod.RodTag.SAPPHIRE_200));

        lstAcRod.add(new ActorRod(467f, 177f, 25f, 25f, ActorRod.RodTag.AMETHYST_300));

        lstAcRod.add(new ActorRod(801f, 142f, 25f, 25f, ActorRod.RodTag.DIAMOND_650));
        lstAcRod.add(new ActorRod(97f, 237f, 25f, 25f, ActorRod.RodTag.DIAMOND_650));
