...
public class ScreenPlayLevel5 extends AbstractScreen {
    ...
    public void show() {
        this.createCamera();
        createStageGame();
        PlayerInfo.setCurrentTarget(4300);
        ...
        lstAcRod.add(new ActorRod(527.5f, 304f, 60f, 50f, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(915f, 323f, 60f, 50f, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(34f, 51f, 60f, 50f, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(328f, 147f, 60f, 50f, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(697.5f, 164f, 60f, 50f, ActorRod.RodTag.ROCK_10));

        lstAcRod.add(new ActorRod(551f, 195f, 60f, 50f, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(72f, 191f, 60f, 50f, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(735f, 282f, 60f, 50f, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(214f, 356f, 60f, 50f, ActorRod.RodTag.ROCK_20));

        lstAcRod.add(new ActorRod(649f, 74f, 60f, 50f, ActorRod.RodTag.GOLD_50));

        lstAcRod.add(new ActorRod(296f, 253f, 60f, 50f, ActorRod.RodTag.GOLD_250));
        lstAcRod.add(new ActorRod(441f, 81f, 60f, 50f, ActorRod.RodTag.GOLD_250));

        lstAcRod.add(new ActorRod(108f, 236f, 80f, 80f, ActorRod.RodTag.GOLD_500));
        lstAcRod.add(new ActorRod(795f, 161f, 80f, 80f, ActorRod.RodTag.GOLD_500));

        lstAcRod.add(new ActorRod(286f, 123f, 25f, 25f, ActorRod.RodTag.EMERALD_100));
        lstAcRod.add(new ActorRod(744f, 208f, 25f, 25f, ActorRod.RodTag.EMERALD_100));
        lstAcRod.add(new ActorRod(34f, 349f, 25f, 25f, ActorRod.RodTag.EMERALD_100));
        lstAcRod.add(new ActorRod(95f, 86f, 25f, 25f, ActorRod.RodTag.EMERALD_100));
