...
public class ScreenPlayLevel4 extends AbstractScreen {
    ...
    public void show() {
        ...
        lstAcRod.add(new ActorRod(168.5f, 341f, 60f, 50f, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(47.5f, 214.5f, 60f, 50f, ActorRod.RodTag.ROCK_10));
        lstAcRod.add(new ActorRod(619.5f, 117f, 60f, 50f, ActorRod.RodTag.ROCK_10));

        lstAcRod.add(new ActorRod(768f, 337.5f, 60f, 50f, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(633f, 102.5f, 60f, 50f, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(822f, 145.5f, 60f, 50f, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(396f, 302.5f, 60f, 50f, ActorRod.RodTag.ROCK_20));
        lstAcRod.add(new ActorRod(85f, 113.5f, 60f, 50f, ActorRod.RodTag.ROCK_20));

        lstAcRod.add(new ActorRod(306f, 214f, 60f, 50f, ActorRod.RodTag.GOLD_50));
        lstAcRod.add(new ActorRod(549f, 50f, 60f, 50f, ActorRod.RodTag.GOLD_50));

        lstAcRod.add(new ActorRod(427.5f, 103f, 60f, 50f, ActorRod.RodTag.GOLD_250));
        lstAcRod.add(new ActorRod(742.5f, 207f, 60f, 50f, ActorRod.RodTag.GOLD_250));

        lstAcRod.add(new ActorRod(217.5f, 85.5f, 80f, 80f, ActorRod.RodTag.GOLD_500));
        lstAcRod.add(new ActorRod(774.5f, 44.5f, 80f, 80f, ActorRod.RodTag.GOLD_500));

        lstAcRod.add(new ActorRod(570.5f, 257.5f, 25f, 25f, ActorRod.RodTag.EMERALD_100));
        lstAcRod.add(new ActorRod(864.5f, 277.5f, 25f, 25f, ActorRod.RodTag.EMERALD_100));
        lstAcRod.add(new ActorRod(168.5f, 227.5f, 25f, 25f, ActorRod.RodTag.EMERALD_100));
